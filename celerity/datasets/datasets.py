...
def alanine_dipeptide_backbone_angles(n_trajectories: int = 1, n_frames: int = 10) -> List[numpy.ndarray]:
    """
    ...
    :param n_trajectories: 1 - 3.  The number of trajectories to return.
    :param n_frames: 1 - 10k. The number of frames in each trajectory.
    :return: A list of length n_trajectories, with each element a numpy array of arr.shape[0] n_frames
    """
    output_dir = Path(__file__) / 'data'
